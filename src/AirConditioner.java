...
public class AirConditioner extends JFrame implements ActionListener {
    ...
    public AirConditioner(Main main) {
        ...
        label2 = new JLabel("Wattage of Your Air Conditioner:");
        label3 = new JLabel(" ");
        ...
        try {
            ImageIcon icon = new ImageIcon("F:\\Java_Project\\Approximate-Electricity-Bill-Calculator\\src\\ac.png");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == button) {
            try {
                ...
                label3.setText("Approx. Monthly Bill: PKR " + String.format("%.2f", bill));
            } catch (Exception ex) {
